...
- [x] 1.0 Complete enum definitions in Prisma schema
  - [x] 1.1 Add PurposeCategory enum to Reference Data section
  ...
  - [x] 1.2 Add PurposeScope enum to Reference Data section
    - File: `/home/user/compilothq/packages/database/prisma/schema.prisma`
    - Location: After PurposeCategory enum
    - Values: INTERNAL, EXTERNAL, BOTH
    - Include descriptive comments for each value
  - [x] 1.3 Add LegalBasisType enum to Reference Data section
    - File: `/home/user/compilothq/packages/database/prisma/schema.prisma`
  ...
  - [x] 1.4 Add RegulatoryFramework enum to Reference Data section
    - File: `/home/user/compilothq/packages/database/prisma/schema.prisma`
  ...
  - [x] 1.5 Run `pnpm prisma format` to validate schema syntax
...
- [x] 2.0 Complete LegalBasis model definition
  ...
  - [x] 2.2 Define core fields for LegalBasis
    - `id` (String, @id @default(cuid()))
    - `type` (LegalBasisType enum)
    - `name` (String)
    - `description` (String)
  - [x] 2.3 Define framework fields for LegalBasis
  ...
  - [x] 2.4 Define consent and assessment flag fields
  ...
  - [x] 2.5 Define additional LegalBasis fields
    - `usageGuidance` (String?, implementation guidance)
    - `isActive` (Boolean, @default(true))
    - `createdAt` (DateTime, @default(now()))
    - `updatedAt` (DateTime, @updatedAt)
  - [x] 2.6 Add indexes for LegalBasis
    - @@index([type])
    - @@index([framework])
  - [x] 2.7 Run `pnpm prisma format` to validate schema
...
- [x] 3.0 Complete Purpose model definition
  ...
  - [x] 3.7 Run `pnpm prisma format` to validate schema
...
- [x] 4.0 Generate and validate database migration
  - [x] 4.1 Generate Prisma migration
  ...
  - [x] 4.2 Review generated migration SQL
...
- [x] 5.0 Complete seed data implementation for LegalBasis
  - [x] 5.1 Create legalBases seed file
    - File: `/home/user/compilothq/packages/database/prisma/seeds/legalBases.ts`
    - Follow dataNatures.ts pattern exactly
  - [x] 5.2 Implement seedLegalBases function
  ...
  - [x] 5.3 Define CONSENT legal basis seed data
    - type: CONSENT
    - name: "Consent"
  ...
  - [x] 5.4 Define CONTRACT legal basis seed data
    - type: CONTRACT
  ...
  - [x] 5.5 Define LEGAL_OBLIGATION legal basis seed data
  ...
  - [x] 5.6 Define VITAL_INTERESTS legal basis seed data
  ...
  - [x] 5.7 Define PUBLIC_TASK legal basis seed data
    - type: PUBLIC_TASK
    - name: "Public Task"
  ...
  - [x] 5.8 Define LEGITIMATE_INTERESTS legal basis seed data
...
- [x] 6.0 Complete DAL implementation
  - [x] 6.1 Create legalBases DAL module
    - File: `/home/user/compilothq/packages/database/src/dal/legalBases.ts`
    - Follow countries.ts pattern
  - [x] 6.2 Implement legalBases DAL functions
  ...
  - [x] 6.5 Export DAL modules from index
...
- [x] 7.0 Complete test factory implementation
  - [x] 7.1 Create LegalBasis factory
  ...
  - [x] 7.3 Export factories from index
...
- [x] 8.0 Complete integration tests
  - [x] 8.1 Write 4-6 focused tests for LegalBasis DAL
  ...
  - [x] 8.2 Write 4-6 focused tests for Purpose DAL
  ...
  - [x] 8.3 Run integration tests and verify they pass
